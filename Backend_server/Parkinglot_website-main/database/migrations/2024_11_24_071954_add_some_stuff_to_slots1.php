...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        DB::table('slots1')->where('slot_id', 0)->update([
            'slot_id' => 0,
            'slot_name' => '3 thang 2',
            'slot_status' => 1,
        ...
        DB::table('slots1')->where('slot_id', 1)->update([
            'slot_id' => 1,
        ...
        DB::table('slots1')->where('slot_id', 2)->update([
            'slot_id' => 2,
        ...
        DB::table('slots1')->where('slot_id', 3)->update([
            'slot_id' => 3,
        ...
        DB::table('slots1')->where('slot_id', 4)->update([
            'slot_id' => 4,
            'slot_name' => 'Lu Gia',
            'slot_status' => 1,
        ...
        DB::table('slots1')->where('slot_id', 5)->update([
            'slot_id' => 5,
